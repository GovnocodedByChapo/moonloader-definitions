...
---
--- Записывает значение типа float (4 байта) в BitStream.<br/>
---
...
--- А именно: string text, string prefix, int color, int pcolor<br/>
---
...
---
--- Читает значение типа float из BitStream.<br/>
---
